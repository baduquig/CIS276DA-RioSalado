...
function sampdb_connect ()
{
  $dbh = new PDO("mysql:host=localhost;dbname=sampdb",
                 "BADUQ", "PASSWORD"); # <PASSWORD> is a placeholder value for assignment submission.
                                         # Actual password included in my local 'C:\usr\local\apache\lib\php\sampdb.php' file
